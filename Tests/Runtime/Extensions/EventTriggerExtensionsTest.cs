...
namespace TestHelper.UI.Extensions
{
    ...
    public class EventTriggerExtensionsTest
    {
        ...
        {
            yield return new TestCaseData(typeof(IPointerEnterHandler), EventTriggerType.PointerEnter).SetName(
                "PointerEnter");
            yield return new TestCaseData(typeof(IPointerExitHandler), EventTriggerType.PointerExit).SetName(
                "PointerExit");
            yield return new TestCaseData(typeof(IPointerDownHandler), EventTriggerType.PointerDown).SetName(
                "PointerDown");
            yield return new TestCaseData(typeof(IPointerUpHandler), EventTriggerType.PointerUp).SetName("PointerUp");
            yield return new TestCaseData(typeof(IPointerClickHandler), EventTriggerType.PointerClick).SetName(
                "PointerClick");
            ...
            yield return new TestCaseData(typeof(IUpdateSelectedHandler), EventTriggerType.UpdateSelected).SetName(
                "UpdateSelected");
            ...
            yield return new TestCaseData(typeof(IInitializePotentialDragHandler),
                EventTriggerType.InitializePotentialDrag).SetName("InitializePotentialDrag");
