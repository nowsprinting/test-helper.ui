...
#pragma warning restore THP3001
    {
        ...
        private static string GetDefaultFilenamePrefixOnTest()
        {
        ...
        /// </summary>
        /// <param name="callerMemberName">Caller member name generated by <c cref="CallerMemberNameAttribute">CallerMemberNameAttribute</c> at anywhere. It must not be an empty or <c>null</c></param>
        private static string GetDefaultFilenamePrefix(string callerMemberName)
        {
#if UNITY_INCLUDE_TESTS
